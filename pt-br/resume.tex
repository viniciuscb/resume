...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
    ...
    embarcados. Sólido histórico de conduzir funcionalidades complexas de ponta a ponta em
    diversas indústrias, stacks tecnológicos e equipes ágeis remotas.
...
\resumeSubHeadingListStart
  ...
  %----- EITA -----
  \resumeSubheading
    {Co-owner, Engenheiro de Software Sênior -- Full-Stack e Mobile}{Dez 2013 -- Out 2024}
